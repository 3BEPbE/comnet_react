...
export default function Movies({navigation}){
    ...
    const [enterPress,setEnterPressed] = React.useState(false)
    const [janrID,setJanrID] = React.useState(null)
    const [janrList,setJanrList] = React.useState()
    const [chosedJanr,setChosedJanr] = React.useState(null)
