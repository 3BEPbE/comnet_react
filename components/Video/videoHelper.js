...
export const openFullScreen = async (setScreen,setStatusHidden) =>{
...
export const closeFullScreen = async (setScreen,setStatusHidden) =>{
...
export  const doubleClick = (condition,doubleClickCounter,removeClickTime,setSkipIcon,status,video) =>{
